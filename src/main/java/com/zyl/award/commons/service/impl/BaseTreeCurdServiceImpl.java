...
import com.zyl.award.commons.service.TreeCrudService;
...
@Slf4j
public abstract class BaseTreeCurdServiceImpl<E extends TreePO<PK>, PK> extends BaseMySqlBaseCrudServiceImpl<E, PK> implements TreeCrudService<E, PK> {
